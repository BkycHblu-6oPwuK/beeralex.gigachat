<?
$localOptionsFileName = 'beeralex_gigachat_options.php';
...
if(file_exists($bitrixPath . $basePathToOptions)) {
    $beeralex_gigachat_default_option = include $bitrixPath . $basePathToOptions;
} elseif (file_exists($localPath . $basePathToOptions)) {
    $beeralex_gigachat_default_option = include $localPath . $basePathToOptions;
}